...
let builtPackageEnvironmentPromise: Promise<{ runePackageRoot: string }> | undefined;
...
async function ensureBuiltPackageEnvironment(): Promise<{ runePackageRoot: string }> {
